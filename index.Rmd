...
```{r example_1, fig.align='center', fig.height=4.5, fig.width = 14}
...
> Build an in-depth understanding of available data assets... Perform ad-hoc exploratory statistics and data mining tasks on diverse data sets from small scale to big data...Participate in data architecture and engineering to support analytics... Investigate data visualization and summarization... Communicate findings to stakeholders... Code the solutions...
...
* Elegant and powerful R framework from RStudio to develop modern responsive apps without requiring expertise in HTML, CSS or JS
* Rapid development and iteration time
* Compelling interactive tools with the power to communicate complex analysis
* Allows anyone to run a script/program on command at the click of a button
